...
FILE_LINE_COVERAGE_THRESHOLDS = {
    Path('scripts/core/data_io.py'): 90.0,
    Path('scripts/core/elo_core.py'): 95.0,
    Path('scripts/core/home_advantage.py'): 95.0,
    Path('scripts/core/optimise.py'): 84.0,
    Path('scripts/core/scoring.py'): 90.0,
    Path('scripts/elo_history_generator.py'): 78.0,
    Path('scripts/elo_margin_methods_optimize.py'): 89.0,
    Path('scripts/elo_margin_methods_predict.py'): 88.0,
    Path('scripts/elo_margin_optimize.py'): 94.0,
    Path('scripts/elo_margin_predict.py'): 90.0,
    Path('scripts/elo_margin_train.py'): 95.0,
    Path('scripts/elo_predict_combined.py'): 87.0,
    Path('scripts/elo_win_optimize.py'): 94.0,
    Path('scripts/elo_win_predict.py'): 90.0,
    Path('scripts/elo_win_train.py'): 76.0,
    Path('scripts/season_simulator.py'): 81.0,
}
FILE_BRANCH_COVERAGE_THRESHOLDS = {
    Path('scripts/core/data_io.py'): 70.0,
    Path('scripts/core/elo_core.py'): 93.0,
    Path('scripts/core/home_advantage.py'): 96.0,
    Path('scripts/core/optimise.py'): 72.0,
    Path('scripts/core/scoring.py'): 90.0,
    Path('scripts/elo_history_generator.py'): 59.0,
    Path('scripts/elo_margin_methods_predict.py'): 71.0,
    Path('scripts/elo_margin_predict.py'): 62.0,
    Path('scripts/elo_margin_train.py'): 90.0,
    Path('scripts/elo_predict_combined.py'): 60.0,
    Path('scripts/elo_win_predict.py'): 60.0,
    Path('scripts/elo_win_train.py'): 72.0,
    Path('scripts/season_simulator.py'): 68.0,
}
