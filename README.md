...
The ELO chart uses two types of rating data:

**Single Year Data**: Rating history files generated by the ELO prediction model for individual seasons
- Files: `afl_elo_rating_history_from_YYYY.csv`
- Shows team ratings at the start of each round

**Year Range Data**: Comprehensive historical ELO data generated with optimal parameters
- Files: `afl_elo_full_history_1990_to_2025.csv`, `afl_elo_complete_history_2020_to_2025.csv`
- Complete match-by-match rating progression across multiple years
- Uses optimal ELO parameters from trained models
