...
- Margin model artifacts include `trained_through_year` when generated by current training scripts; older artifacts can still infer this from `trained_to_YYYY` filenames.
